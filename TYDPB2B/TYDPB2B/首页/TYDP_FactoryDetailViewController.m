...
//            make.width.mas_equalTo(bottomCellHeight);
        ...
        [bottomMeasureLabel setText:[NSString stringWithFormat:@"%@",NSLocalizedString(@"RMB/MT", nil)]];
        ...
        [bottomAmountLabel setText:[NSString stringWithFormat:@"500%@",NSLocalizedString(@"ctn/MT",nil)]];
