...
//        }];
    ...
    [addbtn setTitle:self.type==0? NSLocalizedString(@"Add consignee", nil):NSLocalizedString(@"Add consigner", nil) forState:UIControlStateNormal];
...
- (void)changeBottomBtn{
    ...
    if (_currentIndex) {
        ...
        [btn setTitle:self.type==0? NSLocalizedString(@"Add consignee", nil):NSLocalizedString(@"Add consigner", nil) forState:UIControlStateNormal];
